...
<p class="text-sm mt-2">Whoosah! Let's get you into your account.</p>
<form method="POST" action="/reset-password" class="mt-8">
    ...
    <div class="space-y-6">
        <div>
            ...
            <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}" required class="mt-1 block w-full p-3 text-gray-900 placeholder-gray-400 rounded">
            @error('email')
            <div class="mb-8 text-sm text-red-300 mt-1" role="alert">
                {{ $message }}
            </div>
            @enderror
        </div>
        ...
        <div>
            ...
            <input id="password" type="password" name="password" required class="mt-1 block w-full p-3 text-gray-900 placeholder-gray-400 rounded">
            @error('password')
            <div class="mb-8 text-sm text-red-300 mt-1" role="alert">
                {{ $message }}
            </div>
        ...
        <div>
            ...
            <input id="password-confirm" type="password" name="password_confirmation" required class="mt-1 block w-full p-3 text-gray-900 placeholder-gray-400 rounded">
        </div>
    </div>
