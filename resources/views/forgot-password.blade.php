...
<p class="text-sm mt-2">No worries! Just let me know your email address.</p>
<form method="POST" action="{{ route('password.email') }}" class="mt-8">
    ...
    <div>
        ...
        <div class="col-md-6">
            <input id="email" type="email" name="email" required class="mt-1 block w-full p-3 text-gray-900 placeholder-gray-400 rounded">
        </div>
    </div>
