...
<form method="POST" action="/login" class="mt-8">
    ...
    <div class="space-y-6">
        <div>
            ...
            <input id="email" type="email" name="email" required class="mt-1 block w-full p-3 text-gray-900 placeholder-gray-400 rounded" value="{{ old('email') }}">
        </div>
    ...
    <div class="mt-8">
        <a href="/forgot-password" class="text-sm font-medium text-pink-500 hover:text-pink-400 hover:underline">
            I'm lame and don't know my password
        </a>
    </div>
</form>
@endsection